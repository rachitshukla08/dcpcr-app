...
const Header = () => {
  return (
    <div>
      <div className="border-b-2 flex justify-end pr-32 h-16 text-center font-medium gap-4">
        {/* Top part */}
      ...
      {/* 2 buttons */}
      <div className="mt-5 flex gap-16 px-24">
        <img className="dcpcr-img" src={require("../assets/dcpcr-left.png")} />
        <img
