  ...
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        <br />
        iii. Resident of NCT of Delhi for minimum 5 years preceding the date of
        submission of application.
        <br />
        iv. Should have a 'single-operated' account in any Bank or Post Office
        for receiving the payment through electronic clearing system
        <br />
        v. Must not be receiving any pension/financial assistance from any other
        government bodies or any other source for this purpose
      </p>
    ),
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        <br />
        iv. Bank account number (Single account) v. Disability Certificate
        issued by a Govt. Hospital
        <br />
...
const financial2 = [
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        <br />
        i. Starting any activity contributing directly or indirectly in the
        income generation or helping PwD in their overall process of
        empowerment. Pursuing higher education after class 12th (UG, PG,
        Professional courses and other courses approved by
        UGC/AICTE/ICAR/Government etc.)
        <br />
        ii. Pursuing vocational or skill development (ITI, Diploma any other
        course leading to enhancement of employment or self-employment)
        <br />
        iii. Purchase and/or fitment of any assistive
        device(s)/customization/retrofitting or conversion of available machine,
        equipment, vehicle to disabled-friendly mode.
        <br />
        iv. The upper limit to extend concessional credit through various
        National Handicapped Finance and Development schemes would be Rs.50.0
        lakhs per beneficiary/unit. The actual loan amount within the upper
        limit of Rs.50.0 lakhs shall be determined by implementing agencies
        based on the needs of the activity/project being funded as well as
        repaying capacity of the borrower within the maximum repayment period.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        State Government or as mentioned in the 10th certificate or any other
        certificate issued by the government would be the required document.
        (Aadhar Card would be best)
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        year is the relevant assessment year (AY) for that fiscal year.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        At Appellate Level- Office of the Chief Commissioner for Persons with
        Disabilities, Sarojini House, 6, Bhagwan Das Rd, Bhagwan Das Lane, Mandi
        House, New Delhi, Delhi 110001, 011 2338 6054, Phone- 011 2338 6054,
...
const financial4 = [
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        person with disability can claim tax deduction of up to Rs. 75,000.
        <br />
        ii. Dependent person with severe disability - A dependent person with
        severe disability is one who has at least 80% of any disability. The
        family member handling the medical expenses of a dependent person with
        severe disability can claim tax deduction of up to Rs. 1,25,000.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        <br />
        ii. The taxpayer has borne expenses for medical treatment and training &
        rehabilitation of the dependent with disability or the taxpayer has paid
        premium for a specific insurance policy designed for such cases.
        <br />
        iii. The taxpayer cannot claim this deduction if the dependant has
        already claimed deduction under Section 80U for himself or herself.
        <br />
        iv. The disabled individual is wholly or to a large extent dependent on
        the taxpayer for their support.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className='text-sm font-light my-1'>
        ...
        relevant assessment year (AY) for that FY.
      </p>
    ),
  },
  {
...
export { financial1, financial2, financial3, financial4 };
